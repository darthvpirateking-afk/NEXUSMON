...
def main():
    ...
    print(
        f"   â€¢ Actions per day: {metrics['completed_verified_actions_per_day']:.2f}"
    )
    ...
    for description, params, expected in test_cases:
        task = TaskContext(task_id="test", intent=description, parameters=params)
