...
@app.get("/v1/evolution/status/{agent_id}")
def evolution_status(agent_id: str):
...
@app.post("/v1/federation/register")
...
@app.post("/v1/federation/coordinate")
...
@app.post("/v1/worldspace/connect")
...
@app.post("/v1/worldspace/synthesize")
...
@app.post("/v1/intelligence/cosmic/deep-query")
...
@app.post("/v1/intelligence/cosmic/timeline")
...
@app.post("/v1/intelligence/cosmic/compare")
...
@app.get("/v1/artifacts/{artifact_id}/renders")
...
@app.get("/v1/artifacts/templates/{name}")
